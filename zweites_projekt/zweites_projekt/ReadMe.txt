========================================================================
    KONSOLENANWENDUNG: zweites_projekt-Projektübersicht
========================================================================

Diese zweites_projekt-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre zweites_projekt-Anwendung besteht.


zweites_projekt.vcxproj
...
zweites_projekt.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen zweites_projekt.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
